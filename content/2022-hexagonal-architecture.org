...
* Introduction
** Big Picture
#+REVEAL_HTML: <div class="column" style="width: 80%; align: center;">
...
*** Adapters
- Adapters are sth that talk to the outside world
...
* PlantUML
#+begin_src plantuml :file ./images/hexagonal-architecture/example-hex-arch.png  :results file replace :cmdline -charset UTF-8 :exports results
@startuml
